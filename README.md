...
| -------|---------|-------------|------|
| **Web Projects** |
| :orange_circle: | Web Widgets & Projects | ⭐ A collection of 70+ web widgets, mini projects, and responsive single-page applications built with HTML, CSS, and JavaScript. | :link: [Repo](https://github.com/sidneyshafer/mini-web-projects) |
